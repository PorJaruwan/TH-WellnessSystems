...
# ✅ GET user by ID
@router.get("/{user_id:uuid}", response_class=UnicodeJSONResponse)
...
@router.put("/{user_id:uuid}", response_class=UnicodeJSONResponse)
...
# ✅ DELETE user by ID  
@router.delete("/{user_id:uuid}", response_class=UnicodeJSONResponse)
