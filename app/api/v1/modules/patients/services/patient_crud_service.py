# app\api\v1\modules\patients\services\patient_crud_service.py
...
async def search_patients(
    ...
    """
    ✅ Optimized search:
    - ไม่ load ORM object เต็ม
    - ไม่แตะ relationship
    - ไม่ trigger lazy-load (bookings, etc.)
    """
    ...
    # ✅ select only needed columns (NO ORM full object)
    stmt = (
        select(
            Patient.id,
    ...
    # ✅ convert to dict safely (no lazy load possible)
    items = [
        {
            "id": r.id,
