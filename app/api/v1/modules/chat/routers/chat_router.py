# app/api/v1/modules/chat/routers/chat_router.py
...
from app.api.v1.modules.chat.schemas.envelopes.chat_envelopes import (
    ChatSessionHeaderEnvelope,
    ChatMessagesEnvelope,
    ChatSendMessageEnvelope,
)
from app.api.v1.modules.chat.schemas.chat_model import ChatSendMessageRequest, ChatSendMessagePayload
...
# 9) POST /api/v1/chat/sessions/{session_id}/close
@router.post(
