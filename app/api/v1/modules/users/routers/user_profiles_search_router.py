...
from app.api.v1.modules.users.dependencies import get_user_profiles_search_service
from app.api.v1.modules.users.models.dtos import UserProfileDTO
from app.api.v1.modules.users.models._envelopes import UserProfilesSearchEnvelope
...
def search_user_profiles(
    ...
    svc=Depends(get_user_profiles_search_service),
):
    rows, total = svc.search(q=q, limit=limit, offset=offset)
    items = [UserProfileDTO.model_validate(r, from_attributes=True).model_dump(exclude_none=True) for r in rows]
