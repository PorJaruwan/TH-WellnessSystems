...
from app.api.v1.modules.users.models.users_model import UserGroupsCreateModel, UserGroupsUpdateModel
...
@router.delete("/{user_groups_id:uuid}", response_class=UnicodeJSONResponse)
