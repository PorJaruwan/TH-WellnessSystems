...
from app.api.v1.modules.users.dependencies import get_user_roles_read_service
from app.api.v1.modules.users.models.dtos import UserRoleDTO
from app.api.v1.modules.users.models._envelopes import UserRolesGetEnvelope
...
def get_user_roles_by_id(
    request: Request,
    id: UUID,
    svc=Depends(get_user_roles_read_service),
):
