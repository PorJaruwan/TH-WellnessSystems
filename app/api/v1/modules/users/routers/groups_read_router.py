...
from app.api.v1.modules.users.dependencies import get_groups_read_service
from app.api.v1.modules.users.models.dtos import GroupDTO
from app.api.v1.modules.users.models._envelopes import GroupsGetEnvelope

router = APIRouter()

@router.get("/{id}", response_class=UnicodeJSONResponse, response_model=GroupsGetEnvelope, operation_id="get_groups_by_id")
def get_groups_by_id(
    request: Request,
    id: UUID,
    svc=Depends(get_groups_read_service),
):
