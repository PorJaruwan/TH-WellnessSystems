...
from app.api.v1.modules.users.dependencies import get_groups_search_service
from app.api.v1.modules.users.models.dtos import GroupDTO
from app.api.v1.modules.users.models._envelopes import GroupsSearchEnvelope
...
def search_groups(
    ...
    svc=Depends(get_groups_search_service),
):
    rows, total = svc.search(q=q, limit=limit, offset=offset)
    items = [GroupDTO.model_validate(r, from_attributes=True).model_dump(exclude_none=True) for r in rows]
