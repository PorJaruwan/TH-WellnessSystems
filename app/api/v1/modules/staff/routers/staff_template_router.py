...
#     message="Retrieved successfully.",
#     data={"item": {"id": "uuid", "shift_code": "MORNING", "shift_name": "Morning Shift"}},
# )
...
#             success_key="RETRIEVED",
#             default_message="Retrieved successfully.",
#             data={"item": StaffTemplateResponse.model_validate(obj).model_dump(exclude_none=True)},
#         )
...
#             data={"item": str(staff_template_id)},
#         )
