...
from app.api.v1.modules.users.dependencies import get_user_groups_read_service
from app.api.v1.modules.users.models.dtos import UserGroupDTO
from app.api.v1.modules.users.models._envelopes import UserGroupsGetEnvelope

router = APIRouter()

@router.get("/{id}", response_class=UnicodeJSONResponse, response_model=UserGroupsGetEnvelope, operation_id="get_user_groups_by_id")
def get_user_groups_by_id(
    request: Request,
    id: UUID,
    svc=Depends(get_user_groups_read_service),
):
