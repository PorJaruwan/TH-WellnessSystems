...
#     message="Retrieved successfully.",
#     data={"item": {"id": "uuid", "staff_id": "uuid", "location_id": "uuid", "weekday": 1}},
# )
...
#             success_key="RETRIEVED",
#             default_message="Retrieved successfully.",
#             data={"item": StaffWorkPatternResponse.model_validate(obj).model_dump(exclude_none=True)},
#         )
...
#             data={"item": str(staff_work_pattern_id)},
#         )
